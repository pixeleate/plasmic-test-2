...
import * as sty from "./PlasmicButton.module.css"; // plasmic-import: y-5CxXDvX1fj/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg__mvbPo)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(defaultcss.all, sty.svg___1Dxuw)}
                role={"img"}
              />
            ),
