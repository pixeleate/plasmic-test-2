...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: tm-0BZZOqHGG/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__qcYoo)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox___0SUnd)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <p.PlasmicImg
              alt={""}
              className={classNames(sty.img__czyP)}
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox___2Wadm)}
        >
          <div className={classNames(defaultcss.all, sty.freeBox___4VMy)}>
            {p.renderPlasmicSlot({
