...
import * as sty from "./PlasmicTestimonialsSection1.module.css"; // plasmic-import: TIxM1EJzj74K/css
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__fnUh)}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__srvfC)}
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__d8Zey)}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__sViYu)}
                    displayHeight={"64px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"none" as const}
                    displayMinHeight={"0" as const}
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__mIQfq)}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__boCiV)}
              ...
              <Testimonial
                className={classNames("__wab_instance", sty.testimonial__pneGr)}
                slot={
                  <p.PlasmicImg
                    alt={""}
                    className={classNames(sty.img__xfRjr)}
                    displayHeight={"64px" as const}
                    displayMaxHeight={"none" as const}
                    displayMaxWidth={"none" as const}
                    displayMinHeight={"0" as const}
