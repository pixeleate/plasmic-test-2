...
import Logo from "../../Logo"; // plasmic-import: _34Q1rB7ECpR/component
...
import * as sty from "./PlasmicNavigation.module.css"; // plasmic-import: P2Dx7wzlUWNw/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__c4U5U, {
          [sty.freeBox__centered__c4U5UsiwKb]: hasVariant(
            variants,
            "centered",
            "centered"
          ),
          [sty.freeBox__dark__c4U5UFx1Fv]: hasVariant(variants, "dark", "dark")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Logo className={classNames("__wab_instance", sty.logo__dpq22)} />
          ),
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.freeBox__vOtuu, {
            [sty.freeBox__centered__vOtuusiwKb]: hasVariant(
              variants,
              "centered",
              "centered"
            )
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <Button
                  className={classNames("__wab_instance", sty.button__zn2Ss)}
                  navLink={"navLink" as const}
                  slot={"Services"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__snEd)}
                  navLink={"navLink" as const}
                  slot={"Features"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__eCYtp)}
                  navLink={"navLink" as const}
                  slot={"Company"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__lzkeo)}
                  navLink={"navLink" as const}
                  slot={"Contact"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button___3QjCo)}
                  navLink={"navLink" as const}
                  slot={"Log in"}
                />

                <Button
                  className={classNames("__wab_instance", sty.button__bflat)}
        ...
        {(hasVariant(variants, "centered", "centered") ? true : false) ? (
          <div
            className={classNames(defaultcss.all, sty.freeBox__mj9Kw, {
              [sty.freeBox__centered__mj9KwsiwKb]: hasVariant(
                variants,
                "centered",
                "centered"
              )
          ...
          >
            {(hasVariant(variants, "centered", "centered") ? false : true) ? (
              <button
                className={classNames(
                  ...
                  sty.button__dSr2,
                  {
                    [sty.button__centered__dSr2SiwKb]: hasVariant(
                      variants,
                      "centered",
                      "centered"
                    ),
                    [sty.button__dark__dSr2Fx1Fv]: hasVariant(
                      variants,
                      "dark",
                      "dark"
                    )
            ...
            <Button
              className={classNames("__wab_instance", sty.button__qO1XA, {
                [sty.button__dark__qO1XAFx1Fv]: hasVariant(
                  variants,
                  "dark",
                  "dark"
                )
