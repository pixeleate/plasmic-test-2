...
import * as sty from "./PlasmicListItem.module.css"; // plasmic-import: VQIcoHsNn6Ux/css
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon16Icon
            className={classNames(defaultcss.all, sty.svg___4ZRsm)}
            role={"img"}
          />
        ),
