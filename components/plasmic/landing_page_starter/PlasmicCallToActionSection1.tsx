...
import * as sty from "./PlasmicCallToActionSection1.module.css"; // plasmic-import: bzZ7vDTPIVZo/css
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <React.Fragment>
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__tBuzC)}
                ...
                <div
                  className={classNames(defaultcss.all, sty.freeBox___0LUgn)}
                />
              </React.Fragment>
            ),
            value: args.art
            ...
            defaultContents: (
              <React.Fragment>
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__s3UTe)}
                >
                  <div
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(defaultcss.all, sty.freeBox__uknk5)}
                >
                  <Button
                    className={classNames("__wab_instance", sty.button__d4VDa)}
                  ...
                  <Button
                    ...
                    className={classNames("__wab_instance", sty.button__ykTz)}
