...
import * as sty from "./PlasmicShopBanners.module.css"; // plasmic-import: 5OZJDl5o6p49/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <React.Fragment>
            <Banner
              className={classNames("__wab_instance", sty.banner__xccXh)}
            />

            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(defaultcss.all, sty.freeBox__iNr0)}
            >
              <Banner
                className={classNames("__wab_instance", sty.banner__pRrTg)}
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__cLle7)}
              ...
              <Banner
                className={classNames("__wab_instance", sty.banner__ww5Dx)}
              >
                <p.PlasmicImg
                  alt={""}
                  className={classNames(sty.img__kIMaX)}
                  displayHeight={"100%" as const}
                  displayMaxHeight={"none" as const}
                  displayMaxWidth={"none" as const}
                  displayMinHeight={"0" as const}
