...
import * as sty from "./PlasmicValuesSection2Dark.module.css"; // plasmic-import: sJpqELLdyrYm/css
          ...
          defaultContents: (
            <React.Fragment>
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.freeBox__drTsn)}
              >
                <div
                ...
                <Button
                  children2={
                    <Icon17Icon
                      className={classNames(defaultcss.all, sty.svg___6BiNt)}
                      role={"img"}
                    />
                  }
                  className={classNames("__wab_instance", sty.button___3NrtN)}
              ...
              <div className={classNames(defaultcss.all, sty.freeBox__aRwyy)}>
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem___8MpjT)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__xtNbq)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem__zymNc)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__zz5Gc)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem__msjNm)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg___8NyJa)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  bottomBorder={"dark" as const}
                  className={classNames("__wab_instance", sty.listItem__zJq2L)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__vqeW6)}
                      role={"img"}
                    />
                  }
                >
                ...
                <ListItem
                  className={classNames("__wab_instance", sty.listItem__psB7)}
                  slot={
                    <Icon16Icon
                      className={classNames(defaultcss.all, sty.svg__s95Ib)}
                      role={"img"}
                    />
                  }
                >
